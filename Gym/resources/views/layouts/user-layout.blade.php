...
<body class="sidebar-collapse">
    ...
    @endrole
    @yield('content')
    <a style="position: absolute;right: 20%;bottom: 10%" href="/chatbot">
    <img src="{{asset('imgs/chat.png')}}" style="width:50px">
</a>
    <div id="sidebar-overlay"></div>
    <!-- Option 1: Bootstrap Bundle with Popper -->
    <footer class="main-footer d-flex justify-content-center" style="font-size:13px;">
        <span>Copyright &copy; 2023-2024 <span class="bg-primary px-2 py-1">Gym Ststem.</span></span> All rights
        reserved.
    </footer>
    <!-- jQuery -->
